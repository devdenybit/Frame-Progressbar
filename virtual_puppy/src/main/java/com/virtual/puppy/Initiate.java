...
import com.virtual.puppy.utils.NetworkState;
import com.virtual.puppy.utils.SharedPrefs;
...
public class Initiate {
    ...
    public static Initiate initiates;
    ...
    public Initiate(Activity activitys) {
        activity = activitys;
    }
    ...
    public static Initiate getInstance(Activity gtactivity) {
        activity = gtactivity;
        if (initiates == null) {
            initiates = new Initiate(activity);
        }
        return initiates;
    }


    public void Initiate_call(Activity activity1, String Access_Token, String Base_auth, String Base_Carrier1, Intent next_intent) {
        activity = activity1;
